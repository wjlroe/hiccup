  ...
  (testing "XHTML mode"
    ...
    (is (= (xhtml {:encoding "ISO-8859-1"} [:body "Hello World"])
           (str "<?xml version=\"1.0\" encoding=\"ISO-8859-1\"?>\n"
                ...
                "<html xmlns=\"http://www.w3.org/1999/xhtml\">"
                "<body>Hello World</body></html>"))))
  (testing "DOCTYPE options"
    (is (= (xhtml {:doctype "<!DOCTYPE html>\n"} [:body "Hello World"])
           (str "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n"
                "<!DOCTYPE html>\n"
                "<html xmlns=\"http://www.w3.org/1999/xhtml\">"
                "<body>Hello World</body></html>")))))
  ...
  (testing "XML mode"
    ...
    (is (= (html5 {:xml? true, :lang "en"
           ...
           (str "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n"
                ...
                "<body>Hello World</body></html>"))))
  (testing "DOCTYPE option"
    (is (= (html5 {:xml? true :doctype "<!DOCTYPE html PUBLIC \"-//W3C//DTD XHTML 1.1//EN\" \"http://www.w3.org/TR/xhtml11/DTD/xhtml11.dtd\">\n"}
